...
export const meta: MetaFunction = () => {
  return [
    { title: "Un article | AF" },
    { name: "page d'affichage d'un article du site abraham finance", content: "un article" },
  ];
};
...
<main className="pt-8 pb-16 lg:pt-16 lg:pb-24 bg-white antialiased ">
  ...
  <div className="flex flex-col justify-between px-4 mx-auto max-w-screen-xl ">
    <div className="mt-6 md:mx-[10vw]">
        <div className="relative h-80 w-full overflow-hidden rounded-lg bg-white sm:aspect-h-1 sm:aspect-w-2 lg:aspect-h-1 lg:aspect-w-1 group-hover:opacity-75 sm:h-64">
            <div className="absolute w-full h-full bg-black  opacity-50"></div>
            <h1 className="mb-4 ml-8 absolute bottom-0 text-2xl font-extrabold leading-tight text-white lg:mb-6 lg:text-3xl">Le secret du succès du poulet d'or</h1>
            <img src={'https://tailwindui.com/img/ecommerce-images/home-page-02-edition-01.jpg'} alt={'callout.imageAlt'} className="h-full w-full object-cover object-center" />
        </div>
    </div>
      <article className="mx-auto w-full max-w-2xl format format-sm sm:format-base lg:format-lg format-blue">
          <header className="mb-4 lg:mb-4 not-format">
             
              <h1 className="my-4 text-1xl font-extrabold leading-tight text-gray-900 lg:mb-6 lg:text-2xl">vous allez apprendre plus le secret du succès du poulet d'or dans le monde de l'entreprenariat</h1>
          </header>
          ...
          <p>But then I found a <Link to="https://flowbite.com">component library based on Tailwind CSS called
          ...
          <p>You can check out the <Link to="https://flowbite.com/docs/getting-started/quickstart/">quickstart
          ...
          <p>You'll also receive a lot of useful application UI, marketing UI, and e-commerce pages that can help
              you get started with your projects even faster. You can check out this <Link  to="https://flowbite.com/docs/components/tables/">comparison table</Link> to better understand
      ...
      <div className="grid gap-12 sm:grid-cols-2 lg:grid-cols-4">
          <article className="max-w-xs">
              ...
              <h2 className="mb-2 text-xl font-bold leading-tight text-gray-900 ">
                  <Link to="#">Our first office</Link>
              </h2>
              <p className="mb-4 text-gray-500 ">Over the past year, Volosoft has undergone many changes! After months of preparation.</p>
              <Link to="#" className="inline-flex items-center font-medium underline underline-offset-4 text-primary-600 hover:no-underline">
                  Read in 2 minutes
              </Link>
          </article>
          <article className="max-w-xs">
              <Link to="#">
                  <img className="mb-5 rounded-lg"  src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/article/blog-2.png" alt="Image 2"/>
              </Link>
              <h2 className="mb-2 text-xl font-bold leading-tight text-gray-900">
                  <Link to="#">Enterprise design tips</Link>
              </h2>
              <p className="mb-4  text-gray-500">Over the past year, Volosoft has undergone many changes! After months of preparation.</p>
              <Link to="#" className="inline-flex items-center font-medium underline underline-offset-4 text-primary-600 hover:no-underline">
                  Read in 12 minutes
          ...
          <article className="max-w-xs">
              ...
              <h2 className="mb-2 text-xl font-bold leading-tight text-gray-900">
                  <Link to="#">We partnered with Google</Link>
              </h2>
              <p className="mb-4  text-gray-500">Over the past year, Volosoft has undergone many changes! After months of preparation.</p>
              <Link to="#" className="inline-flex items-center font-medium underline underline-offset-4 text-primary-600 hover:no-underline">
                  Read in 8 minutes
          ...
          <article className="max-w-xs">
              ...
              <h2 className="mb-2 text-xl font-bold leading-tight text-gray-900">
                  <Link to="#">Our first project with React</Link>
              </h2>
              <p className="mb-4  text-gray-500 ">Over the past year, Volosoft has undergone many changes! After months of preparation.</p>
              <Link to="#" className="inline-flex items-center font-medium underline underline-offset-4 text-primary-600 hover:no-underline">
                  Read in 4 minutes
...
<section className="bg-white">
  <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
      <div className="mx-auto max-w-screen-md sm:text-center">
          ...
          <p className="mx-auto mb-8 max-w-2xl  text-gray-500 md:mb-12 sm:text-xl">Stay up to date with the roadmap progress, announcements and exclusive discounts feel free to sign up with your email.</p>
          <form action="#">
              <div className="items-center mx-auto mb-3 space-y-4 max-w-screen-sm sm:flex sm:space-y-0">
                  <div className="relative w-full">
                      ...
                      <input className="block p-3 pl-9 w-full text-sm text-gray-900 bg-white rounded-lg border border-gray-300 sm:rounded-none sm:rounded-l-lg focus:ring-primary-500 focus:border-primary-500" placeholder="Enter your email" type="email" id="email"/>
                  </div>
                  <div>
              ...
              <div className="mx-auto max-w-screen-sm text-sm text-left text-gray-500 newsletter-form-footer">We care about the protection of your data. <Link to="#" className="font-medium text-primary-600 hover:underline">Read our Privacy Policy</Link>.</div>
          </form>
      </div>
  </div>
</section>
